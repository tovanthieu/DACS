	...
	*/
	...
	function initIsotopeFiltering() {
		...
		if ($('.product-grid').length) {
			...
			$('.price_sorting_asc').on('click', function () {
				$('.price_sorting_text').text($(this).text());
				$('.product-grid').isotope({ sortBy: 'price', sortAscending: true });
			});
			$('.price_sorting_desc').on('click', function () {
				$('.price_sorting_text').text($(this).text());
				$('.product-grid').isotope({ sortBy: 'price', sortAscending: false });
			});
